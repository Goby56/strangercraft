...
public class DeadKelpBlock extends AbstractDeadKelpBlock {
    public static final EnumProperty<RailShape> SHAPE = Properties.RAIL_SHAPE;

    public DeadKelpBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected void updateBlockState(BlockState state, World world, BlockPos pos, Block neighbor) {
        if (neighbor.getDefaultState().emitsRedstonePower() && new DeadKelpPlacementHelper(world, pos, state).getNeighborCount() == 3) {
