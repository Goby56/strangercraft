...
public class ModBlocks {
    ...
    public static final Block VINELIKE_TEST_BLOCK = registerBlock("vinelike_test_block", new VinelikeTestBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT).noCollision().requiresTool().sounds(BlockSoundGroup.SCULK_VEIN).strength(0.2f), false, 4), ItemGroup.DECORATIONS, true);
